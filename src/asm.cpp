...
string getTmpReg(int size)//分配临时寄存器
{
    int i=0;
    if(size==4) i=4;
    for (i; i < 14; i++)
...
void handleFuncCall(TreeNode *node)//函数调用转汇编
{
...
string handleExprNode(TreeNode *node)//表达式
{
