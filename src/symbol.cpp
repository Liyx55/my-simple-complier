...
Constant::Constant(Symbol::ValueType type, string value)//常量
    : Symbol (type, value, SYMBOL_CONSTANT)
{

}

Variable::Variable(Symbol::ValueType type, string value)//变量
    : Symbol (type, value, SYMBOL_VARIABLE)
{

}

Callable::Callable(Symbol::ValueType type, string value)//调用
    : Symbol (type, value, SYMBOL_CALLABLE)
{

}

OpNode::OpNode(Symbol::ValueType type, string value)//运算符节点
